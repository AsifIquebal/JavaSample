...
public class JoinDemo {
    ...
    public static void main(String[] args) {
        ...
        // and T3 should start last. You can enforce this ordering using join() method
        // but join method must be called from run() method because the thread which will execute run() method
