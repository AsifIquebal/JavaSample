...
// for static initializations of a class.
// The code inside static block is executed only once: the first time you make an object
// of that class or the first time you access a static member of that class (
